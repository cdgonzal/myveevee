...
| `/swca/funnel-visual` | `src/swca/profileFunnel/SwcaProfileFunnelVisual.tsx` | Post-reward Health Twin CTA visual/function variant for funnel competition | Reusable after provider config extraction | Provider trust copy, compact feature labels, visual asset, redirect destination |
