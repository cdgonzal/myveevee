...
- Route: `/swca/intake`
- Placement: required full-card consent control after ranking and before final submission, with expandable consent details. On mobile, consent is its own guided step after `Ready!`; on desktop, the same consent card appears before submit.
