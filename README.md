...
- Twin Card print layout is deterministic in [print-composer.mjs](/C:/w/myveevee/aws/twin-card/print-composer.mjs:1): marketing-sample white frame, top SWCA summit line, avatar image well with first-name overlay, right-side goal/next-steps copy, provided VeeVee SVG logo assets, and the provided SWCA vector logo asset in the footer.
