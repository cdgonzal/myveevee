  ...
  return (
    <Box as="section" aria-label="Meet your Health Twin" bg="bg.canvas" position="relative" isolation="isolate">
      <Box as="picture" position="absolute" insetX={0} bottom={0} zIndex={-1}
        h={{ base: "292px", sm: "392px", md: "424px", lg: "100%" }}
        sx={{ maskImage: { base: "linear-gradient(to bottom, transparent, black 48px)", lg: "none" } }}>
      ...
      <Container maxW="7xl" px={{ base: 4, md: 8, lg: 12 }}>
        <Grid templateColumns={{ base: "repeat(2, minmax(0, 1fr))", lg: "minmax(0, 1fr) minmax(0, 1.5fr) minmax(0, 1fr)" }}
          ...
          py={{ base: 6, md: 12 }}>
          <Box gridArea="copy" bg="bg.canvas" p={{ base: 0, md: 7 }} maxW="lg" mx="auto" w="full">
            {children}
          </Box>
          <Box gridArea="theo" h={{ base: "260px", sm: "360px", lg: "530px" }} py={4} alignSelf="end">
          ...
          <Box gridArea="nia" h={{ base: "260px", sm: "360px", lg: "530px" }} py={4} alignSelf="end">
