...
export default function Home() {
  ...
  return (
    <Stack spacing={{ base: 10, md: 16 }} py={{ base: 2, md: 6 }}>
      <Grid templateColumns={{ base: "1fr", md: isDark ? "0.9fr 1.1fr" : "1.1fr 1fr" }} gap={{ base: 8, md: isDark ? 8 : 12 }} alignItems="center">
        <Stack spacing={5} bg={isDark ? "bg.canvas" : undefined} py={isDark ? 4 : 0}>
          <Text fontSize="sm" letterSpacing="0.16em" textTransform="uppercase" color="accent.soft">
            Your health, connected
          </Text>
          <Heading as="h1" size={isDark ? { base: "2xl", md: "3xl" } : { base: "xl", md: "2xl" }} lineHeight="1.05"
        ...
        {isDark ? <CampaignScene subject="input" priority h={{ base: "300px", sm: "380px", md: "500px" }} /> : <Box bg={panelBg} borderRadius="3xl" borderWidth="1px" borderColor="border.default" overflow="hidden" p={4}>
