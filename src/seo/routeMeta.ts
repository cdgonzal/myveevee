...
import corePageMeta from "./corePageMeta.json";
...
export const DEFAULT_ROUTE_SEO: RouteSeoMeta = {
  title: corePageMeta["/"].title,
  description: corePageMeta["/"].description,
...
export const ROUTE_SEO: Record<string, RouteSeoMeta> = {
  ...
  [APP_LINKS.internal.howItWorks]: {
    title: corePageMeta["/how-it-works"].title,
    description: corePageMeta["/how-it-works"].description,
    canonicalPath: APP_LINKS.internal.howItWorks,
    robots: DEFAULT_ROBOTS,
    ogType: "website",
    ogImage: DEFAULT_OG_IMAGE,
  ...
  [APP_LINKS.internal.swcaHub]: {
    title: "SWCA Provider Hub | VeeVee Network",
    description:
      "Spine and Wellness Centers of America partners with VeeVee to help people discover rewards, service categories, and public next steps.",
    canonicalPath: APP_LINKS.internal.swcaHub,
    robots: "noindex, nofollow, noarchive, nosnippet",
    ogType: "website",
    ogImage: DEFAULT_OG_IMAGE,
    twitterImage: DEFAULT_OG_IMAGE,
...
for (const [path, meta] of Object.entries(corePageMeta)) {
  ROUTE_SEO[path] = {
    title: meta.title, description: meta.description, canonicalPath: path,
    robots: DEFAULT_ROBOTS, ogType: "website", ogImage: meta.image, twitterImage: meta.image,
  };
}
for (const redirect of marketingRedirects) {
  ROUTE_SEO[redirect.source] = { ...ROUTE_SEO[redirect.target], robots: "noindex, follow" };
}
